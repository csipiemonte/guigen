...
import it.csi.mddtools.guigen.Captcha;
...
public class GuigenPackageImpl extends EPackageImpl implements GuigenPackage {
	 ...
	 * @generated
	 */
	private EClass cpCommandEClass = null;
	 ...
	 * @generated
	 */
	private EClass cpCommandsEClass = null;
	 ...
	 * @generated
	 */
	private EClass captchaEClass = null;
	...
	public static GuigenPackage init() {
		...
		Object registeredGuigenPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GuigenPackageImpl theGuigenPackage = registeredGuigenPackage instanceof GuigenPackageImpl ? (GuigenPackageImpl)registeredGuigenPackage : new GuigenPackageImpl();
	 ...
	 * @generated
	 */
	public EReference getContentPanel_CpCommands() {
	 ...
	 * @generated
	 */
	public EAttribute getColumn_CustomDecorator() {
	 ...
	 * @generated
	 */
	public EAttribute getColumn_FieldLength() {
	 ...
	 * @generated
	 */
	public EAttribute getEventHandler_EventSpecifiers() {
		return (EAttribute)eventHandlerEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSecurityModel_AskForConfirmationOnLogout() {
		return (EAttribute)securityModelEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxPanel_ShowStdLegend() {
		return (EAttribute)msgBoxPanelEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getCPCommand() {
		return cpCommandEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCPCommand_Execute() {
		return (EAttribute)cpCommandEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getCPCommand_Command() {
		return (EReference)cpCommandEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getCPCommands() {
		return cpCommandsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCPCommands_Commands() {
		return (EReference)cpCommandsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getCaptcha() {
		return captchaEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSlider_StaticStep() {
	...
	public void createPackageContents() {
		...
		createEReference(contentPanelEClass, CONTENT_PANEL__CP_COMMANDS);
		...
		createEAttribute(columnEClass, COLUMN__FIELD_LENGTH);
		...
		createEAttribute(eventHandlerEClass, EVENT_HANDLER__EVENT_SPECIFIERS);
		...
		createEAttribute(securityModelEClass, SECURITY_MODEL__ASK_FOR_CONFIRMATION_ON_LOGOUT);
		...
		createEAttribute(msgBoxPanelEClass, MSG_BOX_PANEL__SHOW_STD_LEGEND);
		...
		cpCommandEClass = createEClass(CP_COMMAND);
		createEAttribute(cpCommandEClass, CP_COMMAND__EXECUTE);
		createEReference(cpCommandEClass, CP_COMMAND__COMMAND);
		...
		createEAttribute(sliderEClass, SLIDER__STATIC_STEP);
	...
	public void initializePackageContents() {
		...
		initEReference(getContentPanel_CpCommands(), this.getCPCommands(), null, "cpCommands", null, 0, 1, ContentPanel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_FieldMaxLength(), ecorePackage.getEInt(), "fieldMaxLength", "0", 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getColumn_FieldLength(), ecorePackage.getEInt(), "fieldLength", "0", 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEventHandler_EventSpecifiers(), ecorePackage.getEString(), "eventSpecifiers", null, 0, -1, EventHandler.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSecurityModel_AskForConfirmationOnLogout(), ecorePackage.getEBoolean(), "askForConfirmationOnLogout", null, 0, 1, SecurityModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMsgBoxPanel_ShowStdLegend(), ecorePackage.getEBoolean(), "showStdLegend", null, 0, 1, MsgBoxPanel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(cpCommandEClass, CPCommand.class, "CPCommand", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCPCommand_Execute(), this.getCPCommandExecutionTypes(), "execute", null, 0, 1, CPCommand.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCPCommand_Command(), this.getCommand(), null, "command", null, 0, 1, CPCommand.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSlider_StaticLowerBound(), ecorePackage.getEFloatObject(), "staticLowerBound", null, 0, 1, Slider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSlider_StaticUpperBound(), ecorePackage.getEFloatObject(), "staticUpperBound", null, 0, 1, Slider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSlider_StaticStep(), ecorePackage.getEFloatObject(), "staticStep", "1", 0, 1, Slider.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(cpCommandExecutionTypesEEnum, CPCommandExecutionTypes.class, "CPCommandExecutionTypes");
		addEEnumLiteral(cpCommandExecutionTypesEEnum, CPCommandExecutionTypes.ON_INIT);
		addEEnumLiteral(cpCommandExecutionTypesEEnum, CPCommandExecutionTypes.ON_ENTER);
