...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Grid Panel Layout</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class GridPanelLayoutImpl extends PanelLayoutImpl implements GridPanelLayout {
	/**
	...
	protected EClass eStaticClass() {
		return GuigenPackage.Literals.GRID_PANEL_LAYOUT;
	}
	...
	public void setColumns(int newColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.GRID_PANEL_LAYOUT__COLUMNS, oldColumns, columns));
	}
	...
	public void setRows(int newRows) {
		...
		rows = newRows;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.GRID_PANEL_LAYOUT__ROWS, oldRows, rows));
	}
