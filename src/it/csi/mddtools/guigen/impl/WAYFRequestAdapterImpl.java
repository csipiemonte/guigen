...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>WAYF Request Adapter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class WAYFRequestAdapterImpl extends EObjectImpl implements WAYFRequestAdapter {
	/**
	 ...
	 * @generated
	 */
	protected WAYFRequestAdapterImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GuigenPackage.Literals.WAYF_REQUEST_ADAPTER;
	}
	...
	public void setSourceType(InfoSourceTypes newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.WAYF_REQUEST_ADAPTER__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public void setInfoSourceName(String newInfoSourceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.WAYF_REQUEST_ADAPTER__INFO_SOURCE_NAME, oldInfoSourceName, infoSourceName));
	}
