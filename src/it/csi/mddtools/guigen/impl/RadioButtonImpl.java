 ...
 * <ul>
 *   <li>{@link it.csi.mddtools.guigen.impl.RadioButtonImpl#getMultiDataBinding <em>Multi Data Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RadioButtonImpl extends WidgetImpl implements RadioButton {
	...
	protected EClass eStaticClass() {
		return GuigenPackage.Literals.RADIO_BUTTON;
	}
	...
	public NotificationChain basicSetMultiDataBinding(AppDataBinding newMultiDataBinding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING, oldMultiDataBinding, newMultiDataBinding);
	...
	public void setMultiDataBinding(AppDataBinding newMultiDataBinding) {
		if (newMultiDataBinding != multiDataBinding) {
			...
			if (multiDataBinding != null)
				msgs = ((InternalEObject)multiDataBinding).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING, null, msgs);
			if (newMultiDataBinding != null)
				msgs = ((InternalEObject)newMultiDataBinding).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING, null, msgs);
			msgs = basicSetMultiDataBinding(newMultiDataBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING, newMultiDataBinding, newMultiDataBinding));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MultiDataWidget.class) {
			switch (derivedFeatureID) {
				case GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING: return GuigenPackage.MULTI_DATA_WIDGET__MULTI_DATA_BINDING;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MultiDataWidget.class) {
			switch (baseFeatureID) {
				case GuigenPackage.MULTI_DATA_WIDGET__MULTI_DATA_BINDING: return GuigenPackage.RADIO_BUTTON__MULTI_DATA_BINDING;
				default: return -1;
			}
		}
