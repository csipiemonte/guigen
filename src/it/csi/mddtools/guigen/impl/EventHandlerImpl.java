 ...
 * <ul>
 *   <li>{@link it.csi.mddtools.guigen.impl.EventHandlerImpl#getActions <em>Actions</em>}</li>
...
public class EventHandlerImpl extends EObjectImpl implements EventHandler {
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, GuigenPackage.EVENT_HANDLER__ACTIONS);
		}
		return actions;
	}
