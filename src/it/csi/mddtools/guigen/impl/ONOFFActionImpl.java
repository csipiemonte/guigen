...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ONOFF Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.csi.mddtools.guigen.impl.ONOFFActionImpl#getTargetWidgets <em>Target Widgets</em>}</li>
 *   <li>{@link it.csi.mddtools.guigen.impl.ONOFFActionImpl#isEnable <em>Enable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ONOFFActionImpl extends ActionImpl implements ONOFFAction {
	/**
	...
	protected EClass eStaticClass() {
		return GuigenPackage.Literals.ONOFF_ACTION;
	}
	...
	public EList<Widget> getTargetWidgets() {
		if (targetWidgets == null) {
			targetWidgets = new EObjectResolvingEList<Widget>(Widget.class, this, GuigenPackage.ONOFF_ACTION__TARGET_WIDGETS);
		}
	...
	public void setEnable(boolean newEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GuigenPackage.ONOFF_ACTION__ENABLE, oldEnable, enable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GuigenPackage.ONOFF_ACTION__TARGET_WIDGETS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActionOnWidgets.class) {
			switch (derivedFeatureID) {
				case GuigenPackage.ONOFF_ACTION__TARGET_WIDGETS: return GuigenPackage.ACTION_ON_WIDGETS__TARGET_WIDGETS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActionOnWidgets.class) {
			switch (baseFeatureID) {
				case GuigenPackage.ACTION_ON_WIDGETS__TARGET_WIDGETS: return GuigenPackage.ONOFF_ACTION__TARGET_WIDGETS;
				default: return -1;
			}
		}
