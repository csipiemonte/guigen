...
public class GenUtilsLayout {
	 ...
	 * - � ammesso un solo sottopannello per ciascuno dei cinque quadranti (check)
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	// Metodi generici per funzionalit� specifiche per layout: 
	...
	public static String getWizardPanelStepCompleteIndex(Panel currentPanel, String index) {
		...
		if ( parent instanceof ContentPanel ) {
			...
			// ho un WizardPanel: devo aggiungere all'indice gi� composto quello dello step
			String newIndex = "";
			int i = 1;
