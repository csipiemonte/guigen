...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.FormPanel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormPanelItemProvider
	 ...
	 * @generated
	 */
	public FormPanelItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormPanel_collapsible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormPanel_collapsible_feature", "_UI_FormPanel_type"),
				 GuigenPackage.Literals.FORM_PANEL__COLLAPSIBLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigenPackage.Literals.FORM_PANEL__SUBPANELS);
			childrenFeatures.add(GuigenPackage.Literals.FORM_PANEL__WIDGETS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FormPanel"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FormPanel_type") :
			getString("_UI_FormPanel_type") + " " + label;
	}
