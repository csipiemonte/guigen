...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.MenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuigenPackage.Literals.MENU_ITEM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_label_feature", "_UI_MenuItem_type"),
				 GuigenPackage.Literals.MENU_ITEM__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
