...
public class EventHandlerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigenPackage.Literals.EVENT_HANDLER__ACTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventHandler.class)) {
			case GuigenPackage.EVENT_HANDLER__EVENT_TYPE:
				...
				return;
			case GuigenPackage.EVENT_HANDLER__ACTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuigenPackage.Literals.EVENT_HANDLER__ACTIONS,
