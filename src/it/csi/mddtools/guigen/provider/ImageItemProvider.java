...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_image_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_image_feature", "_UI_Image_type"),
				 GuigenPackage.Literals.IMAGE__IMAGE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Image.class)) {
			case GuigenPackage.IMAGE__IMAGE:
