...
public class InternalAuthenticationGuardItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigenPackage.Literals.INTERNAL_AUTHENTICATION_GUARD__LOGIN_UI);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuigenPackage.Literals.INTERNAL_AUTHENTICATION_GUARD__LOGIN_UI,
				 GuigenFactory.eINSTANCE.createLocalLoginUI()));
