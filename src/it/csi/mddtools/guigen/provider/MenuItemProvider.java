...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.Menu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuigenPackage.Literals.MENU__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuigenPackage.Literals.MENU__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigenPackage.Literals.MENU__ITEM);
			childrenFeatures.add(GuigenPackage.Literals.MENU__SUBMENU);
			childrenFeatures.add(GuigenPackage.Literals.MENU__SECURITY_CONSTRAINTS);
			childrenFeatures.add(GuigenPackage.Literals.MENU__EVENT_HANDLER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuigenPackage.Literals.MENU__ITEM,
				 GuigenFactory.eINSTANCE.createMenuItem()));

		newChildDescriptors.add
			(createChildParameter
				(GuigenPackage.Literals.MENU__SUBMENU,
				 GuigenFactory.eINSTANCE.createMenu()));
