...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.Panel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PanelItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Panel_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Panel_name_feature", "_UI_Panel_type"),
				 GuigenPackage.Literals.PANEL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Panel_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Panel_label_feature", "_UI_Panel_type"),
				 GuigenPackage.Literals.PANEL__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuigenPackage.Literals.PANEL__LAYOUT);
			childrenFeatures.add(GuigenPackage.Literals.PANEL__LAYOUT_SPEC);
		}
