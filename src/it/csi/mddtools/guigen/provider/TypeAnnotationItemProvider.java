...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.TypeAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeAnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeAnnotation_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeAnnotation_language_feature", "_UI_TypeAnnotation_type"),
				 GuigenPackage.Literals.TYPE_ANNOTATION__LANGUAGE,
				 true,
				 false,
				 false,
	...
	protected void addFqnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeAnnotation_fqn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeAnnotation_fqn_feature", "_UI_TypeAnnotation_type"),
				 GuigenPackage.Literals.TYPE_ANNOTATION__FQN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((TypeAnnotation)object).getLanguage();
