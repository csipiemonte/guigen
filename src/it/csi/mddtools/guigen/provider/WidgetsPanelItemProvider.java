		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WidgetsPanel_summary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WidgetsPanel_summary_feature", "_UI_WidgetsPanel_type"),
				 GuigenPackage.Literals.WIDGETS_PANEL__SUMMARY,
				 true,
				 false,
				 false,
