...
public interface GuigenPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link it.csi.mddtools.guigen.EventHandler#getActions <em>Actions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Actions</em>'.
	 * @see it.csi.mddtools.guigen.EventHandler#getActions()
	 * @see #getEventHandler()
	 * @generated
	 */
	EReference getEventHandler_Actions();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference EVENT_HANDLER__ACTIONS = eINSTANCE.getEventHandler_Actions();
