...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.guigen.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseCase_permission_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseCase_permission_feature", "_UI_UseCase_type"),
				 GuigenPackage.Literals.USE_CASE__PERMISSION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseCase_code_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseCase_code_feature", "_UI_UseCase_type"),
				 GuigenPackage.Literals.USE_CASE__CODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((UseCase)object).getCode();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseCase.class)) {
			case GuigenPackage.USE_CASE__CODE:
